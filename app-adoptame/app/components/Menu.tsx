    ...
    <nav className="bg-[#865E53] text-white p-2 sm:p-4 flex justify-between items-center">
      ...
      <div className="flex items-center space-x-10">
        <Link to="/">
          <img
            ...
            alt="Logo"
            className="ml-2 lg:ml-10 h-8 lg:h-12"
          />
        </Link>

        <h1 className="text-sm sm:text-base md:text-lg font-bold hidden md:block">
          VIDA CON PATITAS
        </h1>
      </div>
      ...
      <ul className="flex space-x-2 sm:space-x-12 md:space-x-24 mr-2 md:mr-8">
        <li className="flex items-center">
          ...
          <Link className="text-sm lg:text-lg" to="/lista">
            Animales
          </Link>
        </li>
        <li className="flex items-center">
        ...
        <li className="flex items-center">
          ...
          <Link className="text-sm lg:text-lg" to="/contacto">
            Contacto
          </Link>
        </li>
      </ul>
